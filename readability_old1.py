#!/usr/bin/env python
from admin.BeautifulSoup import NavigableString
from admin.page_parser import parse, get_title, get_body, Unparseable
...
def main():
  ...
  file = urllib.urlopen('http://www.guardian.co.uk/world/2011/jan/10/gabrielle-giffords-us-politics')
  try:
